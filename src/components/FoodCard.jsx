...
const FoodCard = ({ food = {}, onDelete, onEdit }) => {
  ...
  return (
    ...
    //   {/* Image */}
    //   <div className="rounded-lg max-h-60 w-full object-cover">
    //     <img
    //       className="max-h-60 w-full object-cover hover:scale-105 transition duration-300"
    //       src={
    ...
    //   {/* Title */}
    //   <h3 className="text-gray-900 text-xl font-semibold ml-1 mt-3">
    //     {name}
    //   </h3>

    //   {/* Description */}
    //   <p className="text-gray-500 mt-1 ml-1 text-sm line-clamp-2">
    //     {description}
    //   </p>

    //   {/* Details */}
    //   <div className="space-y-2 pl-1 pt-3 text-[13px]">
    //     <p>
    //       <b>Quantity :</b> {quantityDisplay}
    //     </p>

    //     <p>
    //       <b>Expiry :</b> {expiryDisplay}
    //     </p>
