  ...
  return (
    <div className="text-sm w-40 p-3 bg-white border border-gray-500/30 text-gray-800/80 rounded-md font-medium">
      <ul className="flex flex-col gap-px">
        <li
          className="flex items-center justify-between gap-2 cursor-pointer px-1 py-1 rounded hover:bg-gray-500/20 transition"
          onClick={() => {
            navigate("/updateprofile");
            scrollTo(0, 0);
          }}
        >
          <a href="#" className="-mr-px">
            Edit Profile
          </a>
          <svg
            width="25"
        ...
        <li
          className="flex items-center text-red-600/80 justify-between gap-3 cursor-pointer px-1 py-2 rounded hover:bg-red-600/20 transition"
          onClick={() => {
            logout();
            navigate("/");
            scrollTo(0, 0);
