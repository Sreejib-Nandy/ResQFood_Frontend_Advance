...
const Navbar = () => {
  ...
  return (
    <>
      <div
        className={`fixed top-0 left-0 z-9999 w-full flex items-center justify-between px-4 pr-5 sm:px-6 md:px-8 lg:px-16 py-2 max-md:py-4 text-white ${isHome ? "bg-blue-950/65" : "bg-blue-950/90"} backdrop-blur-md transition-all duration-600`}
      >
        {/* Logo */}
        <Link
          to="/"
        ...
        <div className="flex items-center justify-around">
          <div
            className={`max-lg:absolute max-lg:top-0
                        max-lg:-left-10 max-lg:font-medium max-lg:text-lg z-51 flex flex-col lg:flex-row items-center max-lg:justify-center gap-6 lg:px-6 py-3 max-lg:px-3 max-lg:h-screen lg:rounded-full backdrop-blur-3xl bg-black/85 lg:bg-white/10 lg:border border-gray-300/20 overflow-hidden transition-[width] duration-300 ${
          ...
          {/* PROFILE */}
          {user && (
            <div className="relative ml-5 max-md:ml-18">
              <img
