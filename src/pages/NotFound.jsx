    ...
    return (
        <div className='h-screen flex justify-center items-center'>
            <div className="flex flex-col items-center justify-center text-sm max-md:px-4">
                <h1 className="text-8xl md:text-9xl font-bold text-[#ccff33]">404</h1>
                <div className="h-1 w-16 rounded bg-[#ccff33] my-5 md:my-7"></div>
                ...
                <div className="flex items-center gap-4 mt-6">
                    ...
                    <Link to="/" className="border border-gray-300 px-7 py-2.5 text-gray-800 rounded-md active:scale-95 transition-all">
                        Contact support
                    </Link>
                </div>
            </div>
